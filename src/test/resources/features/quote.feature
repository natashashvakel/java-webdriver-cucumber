@quote
  Feature: Quote OOP
    ...
    Scenario: Market email test oop
      ...
      And I submit the form oop
      Then I see "email" error message "Please enter a valid email address." oop
    ...
    Scenario: Market passwords test oop
      ...
      And I submit the form oop
      Then I see "password" error message "Please enter at least 5 characters." oop
      ...
      And I submit the form oop
      Then I see "confirmPassword" error message "Please enter at least 5 characters." oop
      When I fill out "confirmPassword" field with "54321"
      Then I see "confirmPassword" error message "Passwords do not match!" oop
